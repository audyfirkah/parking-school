        ...
        <table class="w-full border-collapse border border-gray-200 rounded-lg shadow-md">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="border border-gray-300 px-4 py-2 text-left">Kapasitas</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="border border-gray-300 px-4 py-2">{{ $area->nama }}</td>
                    <td class="border border-gray-300 px-4 py-2">{{ $area->kapasitas }}</td>
